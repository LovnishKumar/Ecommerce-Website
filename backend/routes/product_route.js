...
router.get('/searchproducts', async (req, res) => {
  try {
    ...
    // Use a case-insensitive regex to search for products that match the query
...
// Add this route at the end of your existing router
...
router.delete('/removepcart/:productId/:useremail', async (req, res) => {
  try {
    const productId = req.params.productId;
    ...
    // Remove the product from the user's cart based on product ID
    const updatedCart = userCart.filter(item => item.productId.toString() !== productId);
